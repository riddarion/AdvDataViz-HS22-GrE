...
def update_moods(mood_slctd, date_slctd1, date_slctd2):  #, date_slctd1, date_slctd2
    ...
    fig3 = px.bar(dflpd, x="year", y="av. length in min",  template='plotly_white', title = "Average Song Length per Year", color_discrete_sequence=["#1DB954"])
    ...
    fig5 = px.scatter(dff, x="danceability", y="popularity", color="mood", template='plotly_white')
